...
function SignIn ()  {
  ...
  return (
    ...
    shadow-black rounded-md flex flex-col justify-center items-center gap-4 sm:gap-[20px] px-4 sm:px-[20px] py-6 sm:py-0' onSubmit={handleSignin}>
      ...
      <h1 className='text-white text-2xl sm:text-3xl font-semibold mb-4 sm:mb-[30px] text-center'>
        Sign In to  <span className='text-blue-400'>AI Virtual Assistant</span>
         ...
         text-black rounded-full mt-4 sm:mt-[30px]' disabled={loading}>{loading?"loading...":"Sign in"}</button>

         <p className='text-white text-sm sm:text-[16px] cursor-pointer' onClick={()=> navigate("/signup")}>Want to create a new account ? <span className='text-blue-400'>Sign up</span></p>
