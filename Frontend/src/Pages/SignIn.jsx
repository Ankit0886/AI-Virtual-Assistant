...
function SignIn ()  {
  ...
  return (
    ...
    shadow-black rounded-md flex flex-col justify-center items-center gap-[20px] px-[20px] mt-[30px]' onSubmit={handleSignin}>

      <h1 className='text-white text-3xl font-semibold mb-[30px]'>
        Sign In to  <span className='text-blue-400'>AI Virtual Assistant</span>
        </h1>
         ...
         <button className='min-w-[140px] h-[50px] text-[18px] font-semibold bg-white text-black rounded-full mt-[30px]' disabled={loading}>{loading?"loading...":"Sign in"}</button>

         <p className='text-white text-[16px] cursor-pointer' onClick={()=> navigate("/signup")}>Want to create a new account ? <span className='text-blue-400'>Sign up</span></p>
